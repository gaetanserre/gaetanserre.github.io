  ...
  getColors() {
    ...
    for (let j = 0; j < this.intervals.length; j++) {
      ...
      for (let i = start; i < end; i++) {
        gradientColorsArray.push(Gradient.hexToRgb(this.colorGradients[j].getColor(i)));
      }
    }

    gradientColorsArray.push(Gradient.hexToRgb(this.colors[this.colors.length - 1]));
