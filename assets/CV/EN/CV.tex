...
\begin{document}
    ...
    \begin{paracol}{2}
        ...
        % ----- EDUCATION -----
        \cvsection{EDUCATION}
            \cvevent{Master Artificial Intelligence }{| Université Paris-Saclay}{Sept. 2021 -- June 2022}{Orsay, France}
            Noteworthy courses :
            \vspace{2pt}
            \begin{itemize}
            ...
            \cvevent{Bachelor's double degree Mathematics/Computer Science}{| Université Paris-Saclay}{Sept. 2018 -- June 2021}{Orsay, France}
            \begin{itemize}
                \item With honors
            \end{itemize}
        ...
        \cvevent{Stage | }{INRIA \& RTE}{May -- August 2022}{Gif-Sur-Yvette, France}
