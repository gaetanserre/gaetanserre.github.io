...
\begin{document}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{Personal Projects}
            ...
            \href{https://raw.githubusercontent.com/gaetanserre/GAiA/master/article/Performing%20Regression%20on%20Complex%20Data.pdf}
            {\textbf{here}}.\\
            \vspace{4pt}
            \cvtag{Tensorflow}
            \cvtag{C++}
            ...
            \cvevent{Reinforcement learning algorithms |}{\cvrepo{\faGithub}{https://github.com/gaetanserre/Reinforcement-learning-algorithms}}
            {Nov. 2021}{}
            ...
            \cvevent{LiSA |}{\cvrepo{\faGithub}{https://github.com/gaetanserre/LiSA}}
            {Sept. 2020}{}
            A 3D path tracing render engine.\\
            \vspace{4pt}
            \cvtag{C++}
            \cvtag{CUDA}\\
            \vspace{4pt}
