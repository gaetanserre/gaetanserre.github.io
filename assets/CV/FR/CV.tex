    ...
    \begin{paracol}{2}
        ...
        \cvsection{Compétences}
            \cvsubsection{Programmation}
                ...
                \cvtag{OCaml}
                \cvtag{Python}
                \cvtag{Sklearn} \cvtag{Tensorflow} \cvtag{Pandas} \cvtag{Numpy}
                \cvtag{Menhir}
                \cvtag{Ocamllex}
                \cvtag{CUDA}
                \cvtag{GLSL}
        ...
        \cvsection{Profil}
            \begin{quote}
                J'étudie dans le master Artificial Intelligence de Paris-Saclay. Je suis passionné par la compilation, l'intelligence artificielle et la théorie des jeux.
        ...
        \cvsection{Formation}
            ...
            \cvevent{Magistère Informatique }{| Université Paris-Saclay}{Sept. 2020 -- Juin 2023}{Orsay, France}
            \begin{itemize}
              ...
              \item 1\textsuperscript{ère} année:
                    \begin{itemize}
                      \item 16.4/20
                      \item Cours supplémentaires: Compilation et Introduction à l'Intelligence Artificielle
                    \end{itemize}
              \item 2\textsuperscript{ème} année:
                    \begin{itemize}
                      \item Cours supplémentaire: Modèles et langages pour la programmation des systèmes réactifs (ENS Ulm)
                    \end{itemize}
            \end{itemize}
            \divider
            ...
            \begin{itemize}
                ...
                \item Mini Projet: Projet en équipe de 6 ayant pour but de détecter des cellules infectées par la malaria à partir de photos
        ...
        \cvsection{Projets Personnels}
            \cvevent{Deep ViCTORIA |}{\cvrepo{\faGithub}{https://github.com/Plagiat01/Deep-ViCTORIA}}
            {Avril 2021 -- Actuel}{}
            Un moteur d'échecs qui renvoie le meilleur coup à partir d'une position grâce à une analyse en profondeur des coups possibles et du deep learning.\\
            \cvtag{C++} 
            \cvtag{Python}
            \cvtag{Tensorflow}\\
            \vspace{4pt}
            ...
            \cvevent{NeuralNet |}{\cvrepo{\faGithub}{https://github.com/Plagiat01/NeuralNet}}
            {Mai 2021 -- Juin 2021}{}
            Une librairie C++ permettant de créer et d'utiliser un réseau de neurones à partir d'un fichier contenant ses paramètres.\\
            \cvtag{C++}
