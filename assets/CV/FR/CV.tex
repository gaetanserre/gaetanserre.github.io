...
\begin{document}
    ...
    \begin{paracol}{2}
        ...
        % ----- EDUCATION -----
        \cvsection{Formation}
            \cvevent{Master Artificial Intelligence }{| Université Paris-Saclay}{Sept. 2021 -- Juin 2022}{Orsay, France}
            Cours notables :
            \vspace{2pt}
            \begin{itemize}
        ...
        \cvevent{Stage | }{INRIA \& RTE}{Mai -- Août 2022}{Gif-Sur-Yvette, France}
        ...
        \cvevent{Stage | }{LMF - INRIA}{Mai -- Juin 2021}{Gif-Sur-Yvette, France}
        ...
        \cvsection{Quelques projets}
            ...
            {Mai 2022}{}
            Une implémentation de l'algorithme AlphaZero dans un fork de la librairie RLlib.\\
            \vspace{4pt}
            \cvtag{Python}
            \cvtag{Pytorch}\\
            \vspace{4pt}
