...
\begin{document}
	...
	%----------------------------------------------------------------------------------------
	\cvSection{Summary}
	\CVTextBlock{Looking for a graduate internship in the defense/intelligence field related to machine learning.}
	%---------------------------------------------------------------------------------------
	%	Current Position
	%----------------------------------------------------------------------------------------
%	\cvSection{Current Position}
	...
	of challenges
	\href{https://l2rpn.chalearn.org/}{Learning to Run a Power Network} during a special session.}
